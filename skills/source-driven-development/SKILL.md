...
```
Estou usando `for_each` em vez de `count` para recursos endereçados por chave,
...
| "É uma tarefa simples" | Tarefas simples viram templates repetidos no projeto inteiro. |
...
- Citar Stack Overflow ou blog de terceiros como base primária
